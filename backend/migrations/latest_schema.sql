...
-- Generated at: 2025-09-14T13:34:07.717330
...
CREATE TABLE availability (
    ...
    created_timezone VARCHAR(50) DEFAULT UTC,
    browser_timezone VARCHAR(50) DEFAULT UTC,
    course_id VARCHAR(50),
...
CREATE TABLE enrollments (
    ...
    enrolled_timezone VARCHAR(50) DEFAULT UTC,
    approved_date TIMESTAMP,
    approved_timezone VARCHAR(50) DEFAULT UTC,
...
CREATE TABLE quiz_results (
    ...
    completed_timezone VARCHAR(50) DEFAULT UTC,
...
ALTER TABLE quizzes ADD CONSTRAINT fk_quizzes_id FOREIGN KEY (lesson_id) REFERENCES lessons (id);
